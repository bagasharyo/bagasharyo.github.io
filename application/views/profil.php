      ...
      <div class="col-md-8">
        <div class="utama">
          ...
          <div class="kedua">
            ...
            <ul>
              <li>Nama Sekolah : MAN 7 Yogyakarta.</li>
              <li>Status Madrasah : Negeri.</li>
              <li>Alamat : JL. KHA. Dahlan 130 Yogyakarta.</li>
              <li>Kode Pos : 55261.</li>
              <li>Telepon/Fax : 0812345678.</li>
              <li>E-mail madrasah : man7yogya@gmail.com.</li>
            </ul>
          </div>
        </div>
      </div>
