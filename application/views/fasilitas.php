      ...
      <div class="col-md-8">
        <div class="utama">
          ...
          <div class="pertama">
            <h1><b>fasilitas</b></h1>
            <ul>
              <li>Masjid yang mampu menampung 600-an jamaah.</li>
              <li>Pelayanan Terpadu Satu Pintu (PTSP).</li>
              <li>Boarding School khusus Putri.</li>
              <li>Perpustakaan.</li>
              <li>Laboratorium Kimia.</li>
              <li>Laboratorium Fisika.</li>
              <li>Laboratorium Biologi.</li>
              <li>Laboratorium TIK.</li>
              <li>Studio Broadcasting.</li>
