        ...
        <div class="utama">
          <div class="galeri">
            <div class="row text-center">
              <div class="col-md-4">
                <a href="" data-toggle="lightbox" data-galery="galery">
                    <img src="<?= base_url('assets/');?>img/slider/slider1.jpg" class="pl-3" style="width: 300px; height: 200px;">
                  </a>
              </div>
              <div class="col-md-4">
                <a href="" data-toggle="lightbox" data-galery="galery">
                  <img src="<?= base_url('assets/');?>img/slider/slider3.jpg" style="width: 300px; height: 200px;">
                </a>
              </div>
            </div>
          </div>
